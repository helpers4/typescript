 ...
 * When called with a count, returns an array of up to `count` unique random elements.
 * @param array - The source array to pick from
 * @param count - Optional number of elements to pick (unique, without replacement)
